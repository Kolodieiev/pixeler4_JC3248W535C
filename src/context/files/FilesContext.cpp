...
void FilesContext::showFilesTmpl()
{
  ...
  size_title_lbl->setPos(DISPLAY_PADDING, TFT_HEIGHT - size_title_lbl->getHeight() * 2 - 7);
  ...
  _file_pos_lbl->setPos(DISPLAY_PADDING, TFT_HEIGHT - _file_pos_lbl->getHeight() - 2);
