...
void PrefFileServerContext::showMainTmpl()
{
  ...
  _ssid_lbl->setPos(DISPLAY_PADDING, DISPLAY_PADDING);
  ...
  _ssid_txt->setWidth(TFT_WIDTH - DISPLAY_PADDING * 2);
  _ssid_txt->setPos(DISPLAY_PADDING, _ssid_lbl->getYPos() + _ssid_lbl->getHeight() + 1);
  ...
  _pwd_lbl->setPos(DISPLAY_PADDING, _ssid_txt->getYPos() + _ssid_txt->getHeight() + SPACE_BETWEEN);
  ...
  _pwd_txt->setPos(DISPLAY_PADDING, _pwd_lbl->getYPos() + _pwd_lbl->getHeight() + 1);
...
void PrefFileServerContext::showDialogTmpl()
{
  ...
  _dialog_txt->setWidth(TFT_WIDTH - DISPLAY_PADDING * 2);
  ...
  _dialog_txt->setPos(DISPLAY_PADDING, DISPLAY_PADDING);
